...
|---|---|---|---|---|---|
| T001 | [Общие Zod-схемы домена](../tasks/T001_shared-schemas.md) | 0 | T000 | `approved` | agent-arena-01 |
| T003 | [Схема и валидатор asset-manifest](../tasks/T003_asset-manifest.md) | 0 | T000, T001 | `todo` | — |
| T030 | [Модель ситуации + content-pack](../tasks/T030_scenario-model.md) | 3 | T001, T003 | `approved` | agent-arena-01 |
| T031 | [Обёртка seedrandom](../tasks/T031_prng.md) | 3 | T030 | `approved` | agent-arena-01 |
