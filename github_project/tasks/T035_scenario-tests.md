...
- **Статус:** `todo`
- **Исполнитель:** —
- **Зависимости:** T032, T033, T034
- **CEO-гейт:** нет
- **Обновлено:** 2026-09-08

## Цель
Тесты детерминизма, воспроизводимости, кривой сложности, адаптации.

## Критерии приёмки
- [ ] Vitest-покрытие движка ≥80%
...
## Команды статуса
```bash
python3 github_project/_meta/generate.py set-status T035 in_progress --agent <id> --note "что начато"
python3 github_project/_meta/generate.py set-status T035 done --agent <id> --note "тесты и результат"
```
