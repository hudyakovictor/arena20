# T071 · Профиль (XP/ранг/стрик/ачивки)
...
## Критерии приёмки
- [ ] XP/ранг из стора; стрик честный (за анализ, не за клик)
- [ ] Ачивки и founder badge отображаются

## Тест-план
- Playwright: профиль
- Vitest: логика стрика
...
## Команды статуса
```bash
python3 github_project/_meta/generate.py set-status T071 in_progress --agent <id> --note "что начато"
python3 github_project/_meta/generate.py set-status T071 done --agent <id> --note "тесты и результат"
```
