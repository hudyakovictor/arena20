...
> Текущий прототип использует собственные SVG-заглушки и временный набор открытых UI-иконок Lucide.
> Ниже зафиксированы реально используемые и потенциальные источники.
...
## Используемые бесплатные сторонние ассеты

| asset_id | source_url | author | license | attribution_required | download_date | used_in | modified |
|---|---|---|---|---|---|---|---|
| `render/icons/nav-*.svg`, `render/icons/dom-*.svg` | https://www.npmjs.com/package/lucide-static/v/0.468.0 | Lucide Contributors | ISC | текст лицензии сохранён в `public/assets/LUCIDE_LICENSE.txt` | 2026-09-04 | Нижняя навигация, онбординг, домены | `currentColor` заменён на белый для Phaser `setTint()` |
